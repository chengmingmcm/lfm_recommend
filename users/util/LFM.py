...
file_path = r'D:\Demos\python\Recommend\django_auth_example\users\static\users_resulttable.csv'
...
class LFM:
    ...
    def evaluate(self,userid):
        ...
        return precision, recall ,pred_items
